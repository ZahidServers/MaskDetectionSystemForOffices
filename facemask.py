...
knowning={"media/biden.jpg":"Joe Biden","media/om.jpg":"OM","media/tabish.jpg":"Tabish Karadkar","media/zahid.jpg":"Zahid Wadiwale"}
...
#test_image=image.load_img('C:/Users/Om Ghag/Desktop/1/Dataset/test/without_mask/30.jpg',target_size=(150,150,3))
test_image=image.load_img(r'F:/1/test/with_mask/1-with-mask.jpg',target_size=(150,150,3))
test_image
...
while cap.isOpened():
	...
	for(x,y,w,h) in face:
		...
		if pred==1:
			for key, value in knowning.items():
				known_image = face_recognition.load_image_file(key)
				unknown_image = face_recognition.load_image_file("temp.jpg")
				biden_encoding = face_recognition.face_encodings(known_image)[0]
				unknown_encoding = face_recognition.face_encodings(unknown_image)[0]
				results = face_recognition.compare_faces([biden_encoding], unknown_encoding)
				if results==[True]:
					print(value+" has not wore masked properly")
	cv2.imshow('img',img)
